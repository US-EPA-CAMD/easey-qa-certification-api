...
export const dataDictionary = {
  ...
  accuracyTestMethodCode: {
    ...
    metadata: {
      default: {
        description: "Code used to indicate fuel flowmeter accuracy test method.",
        example: "LCRM",
      },
    },
  },
  ...
  averageDifference: {
    ...
    metadata: {
      default: {
        description: "Quarterly average absolute percent difference between baseline ratio and hourly quarterly ratios.",
        example: 0.6,
      },
    },
  },
  averageFuelFlowRate: {
    ...
    metadata: {
      default: {
        description: "Average fuel flow rate (100 scfh for gas and lb/hr for oil).",
        example: 4085,
      },
    },
  },
  ...
  averageReferenceMethodFlow: {
    ...
    metadata: {
      default: {
        description: "Average reference method flow rate during reference flow RATA.",
        example: 125122000,
      },
    },
  },
  averageStackFlowRate: {
    ...
    metadata: {
      default: {
        description: "Average stack flow rate, wet basis, adjusted if applicable for wall effects.",
        example: 90122000,
      },
    },
  },
  averageVelocityWithoutWallEffects: {
    ...
    metadata: {
      default: {
        description: "Average velocity for run, not accounting for wall effects.",
        example: 43.42,
      },
    },
  },
  ...
  avgAbsolutePercentDiff: {
    ...
    metadata: {
      default: {
        description: "Average absolute percent difference between reference ratio (GHR) and hourly ratios (or GHR values).",
        example: 2.7,
      },
    },
  },
  avgSquareVelDiffPressure: {
    ...
    metadata: {
      default: {
        description: "Average of square roots of velocity differential pressures at traverse point.",
        example: null,
      },
    },
  },
  avgVelDiffPressure: {
    ...
    metadata: {
      default: {
        description: "Average velocity differential pressure at traverse point.",
        example: 0.23,
      },
    },
  },
  ...
  beginMinute: {
    ...
    metadata: {
      default: {
        description: "Minute in which information became effective or activity started.",
        example: 8,
      },
      testSummary: {
