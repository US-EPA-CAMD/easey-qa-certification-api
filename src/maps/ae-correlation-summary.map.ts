...
import { AppECorrelationTestSummaryDTO,  } from 'src/dto/app-e-correlation-test-summary.dto';
...
> {
  public async one(entity: AeCorrelationSummaryTest): Promise<AppECorrelationTestSummaryDTO> {
    return {
...
calculatedAverageHourlyHeatInputRate: entity.calculatedAverageHourlyHeatInputRate,
