...
@Injectable()
export class OnlineOfflineCalibrationMap extends BaseMap<OnlineOfflineCalibration, OnlineOfflineCalibrationDTO> {
  public async one(entity: OnlineOfflineCalibration): Promise<OnlineOfflineCalibrationDTO> {
    return {
      id: entity.id,
      ...
      calculatedOfflineUpscaleCalibrationError: entity.calculatedOfflineUpscaleCalibrationError,
      calculatedOfflineZeroCalibrationError: entity.calculatedOfflineZeroCalibrationError,
      calculatedOnlineUpscaleCalibrationError: entity.calculatedOnlineUpscaleCalibrationError,
      calculatedOnlineZeroCalibrationError: entity.calculatedOnlineZeroCalibrationError,
      offlineUpscaleCalibrationError: entity.offlineUpscaleCalibrationError,
      offlineUpscaleInjectionDate: entity.offlineUpscaleInjectionDate?.toLocaleString() ?? null,
      ...
      offlineZeroInjectionDate: entity.offlineZeroInjectionDate?.toLocaleString() ?? null,
      ...
      onlineUpscaleInjectionDate: entity.onlineUpscaleInjectionDate?.toLocaleString() ?? null,
      ...
      onlineZeroInjectionDate: entity.onlineZeroInjectionDate?.toLocaleString() ?? null,
